...
Shopping Cart:
    ...
    - Create a Product class with properties id, name, price, and quantity. Implement a method
    getTotalPrice() that calculates the total price for the product (price * quantity).

- Create a ShoppingCart class that includes an array to store products. Implement methods to
 add a product to the cart, remove a product by id, and calculate the total price of all products
  in the cart.

- Extend the ShoppingCart class by adding a method checkout() that logs the products in the cart
and the total price. Implement a method emptyCart() to clear all products from the cart.
*/
