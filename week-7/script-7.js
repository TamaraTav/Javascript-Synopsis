// 1. დაამატეთ ობიექტში  ფუნქცია სახელად  sayHello რომელიც დაპრინტავს
// ობიექტში სახელის value-ს.
/*
let person = {
  name: "Temo",
};
...
// 3. დაადგინეთ, აქვს თუ არა ობიექტს gender ფროფერთი. თუ არ აქვს, მაშინ შექმენით
// მეთოდი რომელიც იმავე ობიექტს gender ფროფერთის შეუქმნის.
...
// 4. გვაქვს სახელების მასივი. შექმენით ობიექტი, სადაც key-value წყვილებად იქნება
// სახელები და მათი რაოდენობები მასივში.
...
// 5. Object Transformation: Write a function that takes an array of objects
// and transforms them into a single object. The transformation should use a
// specific property of each object as the key and another property as the value.
// For example, given the array [{ id: 1, name: 'Alice' }, { id: 2, name: 'Bob' }],
// and using the id property as the key and the name property as the value, the function
// should return { 1: 'Alice', 2: 'Bob' }.
...
// 6. Object Prototype Extension: Write a function that extends an object's prototype
// with additional methods. The additional methods should perform specific operations on
// the object's properties. For example, extend the Array prototype with a method called
// sum() that calculates the sum of all elements in the array.
